...
TD_plot <- function(data) {
  ...
  scale_x_date(date_breaks = "1 week", date_labels = "%d-%m",
               limits=c(as_date('2020-03-03'),as_date('2020-05-14'))) +
...
From my persepctive the time varying graph is the most useful. Our R0 fell from something like 4 or 6, and fell very steadily to just below 1. Better data, specifically using dates of testing (or symptom start) would allow a more refined analysis, however there is no indication from the case numbers that R0 is falling well below 1 at the moment. This R0 is a function of several different epidemics, one in ocngregated settings, one in health care workers, and one in the wider community.
