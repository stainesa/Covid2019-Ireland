...
ORDER.A <- as.character(CountyOrder$Abbreviation)
...
ORDER.B <- as.character(CountyOrder$CountyName)
...
#  scale_y_log10(limits=c(0.9,60)) +
  ...
  theme(axis.text.x.top = element_text(angle = 270, face='bold',
                                       vjust = 0.5, hjust=1,
                                       size=20)) +
  labs(title =  'Mean 14 day case rate per 100,000 by county',
