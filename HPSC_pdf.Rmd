...
```{r Read one}
HPSC_text <- pdf_text('HPSC/COVID-19 Epidemiology report for NPHET 20200425_website.pdf') %>%
  readr::read_lines() %>%
  tibble()
...
g <- ggplot(data=HH.diff,aes(x=RecordDate, y=Hospitalised)) +
  ...
  scale_x_date(limits=c(as_date('2020-03-21'),as_date('2020-04-26'))) +
